...
namespace Beyova.Gravity
{
    ...
    /// Class GravityHost.
    /// </summary>
    internal class GravityHost
    {
        /// <summary>
        /// The _client key
        /// </summary>
        Guid? _clientKey = null;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GravityHost" /> class.
        /// </summary>
        ...
        protected GravityHost(BeyovaComponentAttribute componentAttribute, GravityEntryObject entry, IEnumerable<IGravityCommandInvoker> commandInvokers, GravityEventHook eventHook)
        {
            this.Entry = entry;
        ...
        /// The host
        /// </summary>
        static GravityHost host = InitializeGravityHost();

        /// <summary>
        /// Gets the host.
        /// </summary>
        /// <value>The host.</value>
        internal static GravityHost Host { get { return host; } }

        /// <summary>
        /// Initializes the gravity host.
        /// </summary>
        /// <returns>Beyova.Gravity.GravityHost.</returns>
        private static GravityHost InitializeGravityHost()
        {
            ...
            return entryObject == null ? null : new GravityHost(componentAttribute, entryObject, invokers, gravityEventHook);
        }
